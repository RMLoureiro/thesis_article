...
\author{%
	Ricardo Loureiro\textsuperscript{1}, António Ravara\textsuperscript{1} and Simão Melo de Sousa\textsuperscript{2}
}

% Affiliations are output in the \date{} command
\date{\footnotesize\textsuperscript{\textbf{1}}Faculty of Science and Technology, NOVA\\ \textsuperscript{\textbf{2}} University of Algarve}
...
liveness but no implementation is given.
